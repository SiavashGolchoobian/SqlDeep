...
/****** Object:  Job [SqlDeep_FullBackup]    Script Date: 2/21/2021 10:35:52 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [SqlDeep Jobs]    Script Date: 2/21/2021 10:35:53 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Take full backup]    Script Date: 2/21/2021 10:35:53 PM ******/
...
EXECUTE [dbo].[dbasp_maintenance_take_backup] 
  ...
  ,@PrintOnly', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Delete old backups]    Script Date: 2/21/2021 10:35:53 PM ******/
