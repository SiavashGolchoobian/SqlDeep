...
/****** Object:  Job [SqlDeep_LogBackup]    Script Date: 3/1/2021 8:48:26 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [SqlDeep Jobs]    Script Date: 3/1/2021 8:48:26 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Take log backup]    Script Date: 3/1/2021 8:48:26 AM ******/
...
EXECUTE [dbo].[dbasp_maintenance_take_backup] 
  ...
  ,@PrintOnly', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Shrink log file]    Script Date: 3/1/2021 8:48:26 AM ******/
