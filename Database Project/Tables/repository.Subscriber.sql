...
GO
CREATE UNIQUE NONCLUSTERED INDEX [UNQ_Repository_Subscriber] ON [repository].[Subscriber] ([PublisherName], [ItemName], [ItemVersion]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [PK_Repository_Subscriber] ON [repository].[Subscriber] ([SubscriberItemId]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
