...
GO
CREATE UNIQUE NONCLUSTERED INDEX [UNQ_Repository_Subscriber] ON [repository].[Subscriber] ([PublisherName], [ItemName], [ItemVersion]) ON [Data_OLTP]
GO
CREATE UNIQUE CLUSTERED INDEX [PK_Repository_Subscriber] ON [repository].[Subscriber] ([SubscriberItemId]) ON [Data_OLTP]
GO
