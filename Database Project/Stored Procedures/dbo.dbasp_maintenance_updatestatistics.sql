...
-- =============================================
-- Author:		<Ian Stirk + Golchoobian + MaziyarMaranaki>
	...
	WHILE @@FETCH_STATUS=0
		BEGIN	
			...
			SET @mySQLScript = @mySQLScript + 
				...
				CASE WHEN @ProductVersionNumber >= 13 THEN
					@myNewLine + N'		AND NOT EXISTS (SELECT 1 FROM [sys].[memory_optimized_tables_internal_attributes] AS myMemoryAttrib WHERE [myMemoryAttrib].[object_id] = [myObjects].[object_id])'
