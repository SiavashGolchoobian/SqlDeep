...
CREATE PROCEDURE [dbo].[dbasp_security_checklist] (
...
WHERE 
    ...
    BEGIN
		...
		WHERE
			CASE 
				WHEN @filterIssues=0 THEN 1 ELSE  
				CASE WHEN Ds_Resultado IN ('OK','Info') THEN 0 ELSE 1 END
			END = 1
    ...
    BEGIN
		...
		WHERE
			CASE 
				WHEN @filterIssues=0 THEN 1 ELSE  
				CASE WHEN Ds_Resultado IN ('OK','Informativo') THEN 0 ELSE 1 END
			END = 1
    END
