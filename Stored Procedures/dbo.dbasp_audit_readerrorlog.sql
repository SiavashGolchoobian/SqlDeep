...
--	@searchstring1:	'...' //Any string you searched for it throught log file
--	@searchstring2:	'...' //Any string you searched for it throught log file
...
--set @end=getdate()
--exec [dbo].[dbasp_audit_readerrorlog] 0,'sql log','error',null,@start,@end,'desc'
-- =============================================
...
BEGIN
	...
	IF (@mylogfiletype IS NULL)
		EXEC sys.xp_readerrorlog @Logfile
	ELSE
		--@SearchString1 , @SearchString2 should be nvarchar, otherwise it will raise error
		EXEC sys.xp_readerrorlog @Logfile,@mylogfiletype,@SearchString1,@SearchString2,@StartDate,@EndDate,@mySortOrder
END
GO
