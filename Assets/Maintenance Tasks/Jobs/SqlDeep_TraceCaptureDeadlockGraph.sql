...
/****** Object:  Job [SqlDeep_TraceCaptureDeadlockGraph]    Script Date: 8/15/2021 11:09:48 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [SqlDeep Jobs]    Script Date: 8/15/2021 11:09:48 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'SqlDeep_TraceCaptureDeadlockGraph', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Insert graph into LogEvents]    Script Date: 8/15/2021 11:09:48 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Insert graph into LogEvents', 
		...
		@command=N'INSERT INTO trace.Events
                ...
                VALUES (getdate(),''DeadLock'', N''$(ESCAPE_SQUOTE(WMI(TextData)))'')', 
